...
export function RegisterPost() {
  ...
  const handleRegisterPost: SubmitHandler<RegisterPostInputs> = (data) => {
    ...
    <main className="flex flex-1 flex-col bg-gray-100 dark:bg-slate-800 w-full">
      <div className="flex flex-col items-center w-[90%] lg:w-[560px] mx-auto">
        <div className="mb-4 w-full">
          <ScreenTitleIcon
            screenTitle="Cadastrar Post"
            iconName="user-check"
          />
        </div>
        <form className="w-full" onSubmit={handleSubmit(handleRegisterPost)}>
          ...
          <div className="w-full mb-4">
            {wasFileUploaded && uploadedFile ? (
              ...
              <FileInput
                ...
                placeholder="Selecione a foto do Post"
